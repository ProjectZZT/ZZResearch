...
{
    /// <summary>
    /// PNSearchWindow.xaml에 대한 상호 작용 논리
    /// </summary>
    public partial class PNSearchWindow : Window
    {
        public PNSearchWindow()
        {
            InitializeComponent();
        }
            ...
            using (SqlConnection con = new SqlConnection(ConString))
            {
                try
                {
                    ...
                    {   //  숫자 검색
                        ...
                        CmdString = "SELECT (mn_sign + 'E' + cast(mn_exp as char(12))) as MNumber, mn_exp, m_addr_a, mother_create_date FROM mothertbl where mn_sign = '" + sign + "'";
                    }
